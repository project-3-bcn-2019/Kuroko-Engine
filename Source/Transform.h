...
public:
	...
	void RotateAroundAxis(const float3& axis, float rot_in_degrees) { rotation = rotation.RotateAxisAngle(axis, DEGTORAD * (rot_in_degrees)); euler_angles = rotation.ToEulerXYZ() * RADTODEG; };
